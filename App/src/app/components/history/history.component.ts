...
export class HistoryComponent implements OnInit {
  ...
  PrevPagination() {
    ...
    this.service.getMethod(`http://skunkworks.ignitesol.com:8000/books/?page=${this.prevPage}&topic=history`).subscribe((data: any) => {
      this.result = data.results
    })
    if (this.prevPage === 1) {
      this.prevPage = 1;
  ...
  pagination() {
    this.service.getMethod(`http://skunkworks.ignitesol.com:8000/books/?page=${this.mainPage}&topic=history`).subscribe((data: any) => {
      this.result = data.results
    })
  }
  ...
  bookTextTormat(id: any) {
    this.service.getMethod(`http://skunkworks.ignitesol.com:8000/books/?ids=${id}&topic=history`).subscribe((data: any) => {
